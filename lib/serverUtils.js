  ...
  switch (dayStatus) {
    case "Present":
      return {
        ...
        message: `${studentName}, You are marked PRESENT today!`,
        icon: baseIcon,
      };
    case "Absent":
      return {
        title: "Attendance Tracker 🔴",
        message: `${studentName}, You are marked ABSENT today!`,
        icon: baseIcon,
      };
    case "Leave":
      return {
        title: "Attendance Tracker 🟡",
        message: `${studentName}, You are on LEAVE today!`,
        icon: baseIcon,
      };
    case "No Change":
      return {
        title: "Attendance Tracker ⚫",
        message: `No attendance change detected for ${studentName}.`,
        icon: baseIcon,
      };
    case "Initial Data":
      return {
        title: "Attendance Tracker 📅",
        message: `Initial attendance data fetched for ${studentName}.`,
        icon: baseIcon,
      };
    default:
      return {
        title: "Attendance Tracker Alert 📝",
